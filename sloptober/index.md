...
- processes (harnesses, software factories, methodologies)
...
1. Accept we are in slop.
2. Mitigate through adoption of a slop appetite putting in place detection and reduction guardrails.
...
- be maintained in an index
- be reviewed against their peers
- be assessed from a default "kill this" and *actually kill them* - that is, we need to demonstrate metrics *greater than zero* that we are deprecating and stopping ideas.

## Examples of things I consider slop
...
- documents take longer to read that to write
- no adoption outside of author
- author forcing on juniors who hate it
